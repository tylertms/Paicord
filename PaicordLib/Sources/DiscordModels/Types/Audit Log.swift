  ...
  public struct Entry: Sendable, Codable {
    ...
    public enum Mixed: Sendable, Codable, CustomStringConvertible {
      ...
      public var description: String {
        ...
        case .strings(let array): return "\(array)"
        case .nameId(let nameId): return "\(nameId)"
        case .nameIds(let nameIds): return "\(nameIds)"
        case .permissionOverwrites(let overwrites): return "\(overwrites)"
        case .permission(let permission): return "\(permission)"
        case .actions(let actions): return "\(actions)"
        case .other(let other): return "\(other.container)"
        }
      }
      ...
      public func encode(to encoder: any Encoder) throws {
        ...
        case .nameId(let nameId):
          try container.encode(nameId)
        case .nameIds(let nameIds):
          try container.encode(nameIds)
        case .permissionOverwrites(let overwrites):
    ...
    public enum Action: Sendable, Codable {
      ...
      public func encode(to encoder: any Encoder) throws {
        ...
        case .channelOverwriteCreate(let overwriteInfo):
          try container.encode(overwriteInfo, forKey: .options)
        case .channelOverwriteUpdate(let overwriteInfo):
          try container.encode(overwriteInfo, forKey: .options)
        case .channelOverwriteDelete(let overwriteInfo):
          try container.encode(overwriteInfo, forKey: .options)
        case .memberKick: break
        case .memberPrune(let delete_member_days):
        ...
        case .memberMove(let channel_id, let count):
          var container = try optionsNestedContainer()
          try container.encode(channel_id, forKey: .channel_id)
          try container.encode(count, forKey: .count)
        case .memberDisconnect(let count):
          var container = try optionsNestedContainer()
          try container.encode(count, forKey: .count)
        case .botAdd: break
        ...
        case .messageDelete(let channel_id, let count):
          var container = try optionsNestedContainer()
          try container.encode(channel_id, forKey: .channel_id)
          try container.encode(count, forKey: .count)
        case .messageBulkDelete(let count):
          var container = try optionsNestedContainer()
          try container.encode(count, forKey: .count)
        case .messagePin(let channel_id):
          var container = try optionsNestedContainer()
          try container.encode(channel_id, forKey: .channel_id)
        case .messageUnpin(let channel_id):
          var container = try optionsNestedContainer()
          try container.encode(channel_id, forKey: .channel_id)
        case .integrationCreate: break
        case .integrationUpdate: break
        case .integrationDelete: break
        case .stageInstanceCreate(let channel_id):
          var container = try optionsNestedContainer()
          try container.encode(channel_id, forKey: .channel_id)
        case .stageInstanceUpdate(let channel_id):
          var container = try optionsNestedContainer()
          try container.encode(channel_id, forKey: .channel_id)
        case .stageInstanceDelete(let channel_id):
          var container = try optionsNestedContainer()
          try container.encode(channel_id, forKey: .channel_id)
        ...
        case .applicationCommandPermissionUpdate(let application_id):
          var container = try optionsNestedContainer()
        ...
        case .autoModerationBlockMessage(let moderationInfo):
          try container.encode(moderationInfo, forKey: .options)
        case .autoModerationFlagToChannel(let moderationInfo):
          try container.encode(moderationInfo, forKey: .options)
        case .autoModerationUserCommunicationDisabled(let moderationInfo):
          try container.encode(moderationInfo, forKey: .options)
